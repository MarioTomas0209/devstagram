...
@section('contenido')
    <div class="md:flex md:gap-10 justify-center md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route('login') }}" novalidate> <!-- RUTA PAR PODER CAMBIAR DE NOMBRE EL web.php -->
                @csrf

                @if (session('mensaje'))
                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-1 text-center">{{ session('mensaje') }}</p>
                @endif {{-- MUESTRA UN MENSAJE DE ERROR (LoginController.php) --}}
                ...
                <div class="mb-5">
                    ...
                    id="password" 
                    name="password" 
                    placeholder="Tu Contraseña Hermanito"
                ...
                {{-- Para que la sesion siempre este iniciada en el name debe ir remember y lo utilizas en el controlador LoginController.php --}}
                <div class="mb-5">
