        ...
        <div class="md:w-1/2">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    {{ $post->created_at->diffForHumans() }}{{-- para poner la fecha que fue creada --}}
                </p>
        ...
        <div class="md:w-1/2 px-5">
            ...
            <div class="shadow bg-white p-5 mb-5">
                ...
                @auth
                    ...
                    @if (session('mensaje'))
                        <div class="bg-green-500 p-2 rounded-lg mb-6 text-white text-center uppercase text-bold">
                            {{ session('mensaje') }}
                        </div>
                    @endif
                ...
                <div class="bg-white shadow mb-5 max-h-96 mt-10 overflow-auto">
